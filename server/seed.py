...
def seed_data():
    ...
    entries_36 = [
        JournalEntry(journal_id=journal_36.id, entry_date=date(2025, 9, 1), mood_tag="Excited", mood_score=8, notes="Kicked off a new project. Energy was high, felt motivated."),
        JournalEntry(journal_id=journal_36.id, entry_date=date(2025, 9, 2), mood_tag="Focused", mood_score=7, notes="Spent hours planning project tasks. Clear roadmap, but workload looks heavy."),
        JournalEntry(journal_id=journal_36.id, entry_date=date(2025, 9, 3), mood_tag="Productive", mood_score=8, notes="Good progress on initial setup. Momentum is strong."),
        JournalEntry(journal_id=journal_36.id, entry_date=date(2025, 9, 4), mood_tag="Anxious", mood_score=5, notes="Started looking at job postings. The market seems very competitive."),
        JournalEntry(journal_id=journal_36.id, entry_date=date(2025, 9, 5), mood_tag="Stressed", mood_score=4, notes="Applied to a few positions but didn’t get responses. Felt pressure mounting."),
        JournalEntry(journal_id=journal_36.id, entry_date=date(2025, 9, 6), mood_tag="Tired", mood_score=5, notes="Worked late on both project and job search. Felt drained."),
        JournalEntry(journal_id=journal_36.id, entry_date=date(2025, 9, 7), mood_tag="Hopeful", mood_score=6, notes="Took a break, tried to reset mindset. Still hopeful things will work out.")
    ]
    ...
    entries_37 = [
        JournalEntry(journal_id=journal_37.id, entry_date=date(2025, 9, 8), mood_tag="Nervous", mood_score=5, notes="Prepared for interviews, but job rejections still in mind."),
        JournalEntry(journal_id=journal_37.id, entry_date=date(2025, 9, 9), mood_tag="Overwhelmed", mood_score=4, notes="Balancing project work and job search feels exhausting. Need better routine.")
    ]
